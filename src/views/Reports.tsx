...
const Reports: FunctionComponent<ReportsProps> = () => {
	...
	const sendBullyingReport = async (reqBody: any) => {
		...
		if ((reqBody.email && !reqBody.email.match(regexEmail)) || (reqBody.adminemail && !reqBody.adminemail.match(regexEmail))) {
		...
		if (result?.length === 0) {
			setModalContent(<div>School is not protected under bullyvax check school name and zip code</div>);
			setMessageType("info");
			setOpenModal(true);
			setLoading(false);
			return;
				...
				<Box sx={{ width: "100%", p: 2 }}>
					<Grid container spacing={2}>
						<Grid item xs={12} sm={12}>
							...
							<p>
								The first step to submitting a report through BullyVaxx is to upload a short, ID verification video. Please follow these 4 guidelines when recording this video 
								<ul>
									<li>All video must be made at arm's lenght from straight ahead clearly showing the person's face and head </li>
									...
									<li>Please say this statement in your video " My BullyVaxx username is _______________ Today's date is ___________ " </li>
								</ul>
							</p>
							{/* <p>
				...
				<Box sx={{ width: "100%", p: 2 }}>
					...
					<StyledTabPanel value={value} index={0}>
						...
						<Form initialValues={bullyingReportForm} buttonText="submit report" buttonSize="medium" submit={sendBullyingReport}>
							...
							username
							<InputField size="small" color="secondary" name="username" type="text" variant="outlined" />
							.<br />
							...
							you.
							<br />
							Your Full Name <InputField size="small" color="secondary" name="full_name" type="text" variant="outlined" />
							<br />
							Your cell phone number <InputField size="small" color="secondary" name="phone" type="text" variant="outlined" />
							<br />
							My e-mail address <InputField size="small" color="secondary" name="email" type="text" variant="outlined" />
							<br />
							Name of School <InputField size="small" color="secondary" name="school_name" type="text" variant="outlined" />
							<br />
							Zip code of School <InputField size="small" color="secondary" name="zip_code" type="text" variant="outlined" />
							<br />
							Principal’s email address <InputField size="small" color="secondary" name="admin_email" type="text" variant="outlined" />
							<br />
							Name of person/student making this threat?{" "}
							<InputField size="small" color="secondary" name="bully_fullname" type="text" variant="outlined" />
							<br />
							...
							<InputField size="small" color="secondary" name="bully_grade" type="number" variant="outlined" />
							<br />
							Homeroom Teacher of person/student making this threat.{" "}
							<InputField size="small" color="secondary" name="bully_teacher" type="text" variant="outlined" />
							<br />
							When is this attack supposed to occur? <InputField size="small" color="secondary" name="incident_date" type="date" variant="outlined" />
							<br />
							...
							<InputField size="small" color="secondary" name="bully_supporters" type="text" variant="outlined" />
							<br />
							In complete detail provide all information you have on this threat.{" "}
							<InputField size="small" color="secondary" name="other_incidents" type="text" variant="outlined" isMultiline={true} />
							<br />
					...
					<StyledTabPanel value={value} index={1}>
						...
						<Form initialValues={bullyingReportForm} buttonText="submit report" buttonSize="medium" submit={sendBullyingReport}>
							...
							my username <InputField size="small" color="secondary" name="username" type="text" variant="outlined" />. <br />
							If you have any further questions or need to immediately verify this information please contact me and I will provide the answers for
							you. <br />
							Your Full Name <InputField size="small" color="secondary" name="full_name" type="text" variant="outlined" />
							<br />
							...
							My e-mail address <InputField size="small" color="secondary" name="email" type="text" variant="outlined" />
							<br />
							Name of County <InputField size="small" color="secondary" name="country" type="text" variant="outlined" />
							<br />
							County Sheriff's email address <InputField size="small" color="secondary" name="admin_email" type="text" variant="outlined" />
							<br />
							Name of person/student making this threat?{" "}
							<InputField size="small" color="secondary" name="bully_fullname" type="text" variant="outlined" />
							<br />
					...
					<StyledTabPanel value={value} index={2}>
						...
						<Form initialValues={bullyingReportForm} buttonText="submit report" buttonSize="medium" submit={sendBullyingReport}>
							...
							<InputField size="small" color="secondary" name="bully_grade" type="text" variant="outlined" />
							<br />
							Homeroom Teacher of person/student bringing the weapon to school{" "}
							<InputField size="small" color="secondary" name="bully_teacher" type="text" variant="outlined" />
							<br />
							What type of weapon is this? <InputField size="small" color="secondary" name="weapon_type" type="text" variant="outlined" />
							<br />
							Do any other people/students have knowledge of this threat? <br />
							...
							<InputField size="small" color="secondary" name="waepon_store" type="text" variant="outlined" />
							<br />
							Do you know why this student is bringing this weapon to school?{" "}
							<InputField size="small" color="secondary" name="weapon_reson" type="text" variant="outlined" />
							<br />
							In complete detail provide all information you have on this threat.{" "}
							<InputField size="small" color="secondary" name="other_incidents" type="text" variant="outlined" isMultiline={true} />
							<br />
					...
					<StyledTabPanel value={value} index={3}>
						...
						<Form initialValues={bullyingReportForm} buttonText="submit report" buttonSize="medium" submit={sendBullyingReport}>
							I have information involving bullying in your school. I am reporting this information through The BullyVaxx system. If you are not
							familiar with The BullyVaxx system please go to www.bullyvaxx.com for details. Once you are on the site if you will click on the School
							Administrator tab at the top of the Home page complete instructions for BullyVaxx will be provided for you. At the bottom of this page
							is a link where you can review my identification video. Thank you
							<FRadioButton
								name="trustee_or_not"
								options={[
									"I am a trustee reporting this information for another individual who requests to not be identified; however, I will act as an intermediary so you can immediately access any additional information you need.",
							...
							<InputField size="small" color="secondary" name="bully_finitial" type="text" variant="outlined" />
							<br />
							What is the bully’s last name <InputField size="small" color="secondary" name="bully_lname" type="text" variant="outlined" />
							<br />
							Full name of bully <InputField size="small" color="secondary" name="bully_fullname" type="text" variant="outlined" />
							<br />
							Gender of bully: <br />
							<FRadioButton name="gender" options={["Male", "Female"]} />
							<br />
							Grade of bully. <InputField size="small" color="secondary" name="bully_grade" type="text" variant="outlined" />
							<br />
							Homeroom Teacher of bully <InputField size="small" color="secondary" name="bully_teacher" type="text" variant="outlined" />
							<br />
							Date of incident <InputField size="small" color="secondary" name="incident_date" type="date" variant="outlined" />
							<br />
							Time of incident <InputField size="small" color="secondary" name="incident_time" type="time" variant="outlined" />
							<br />
							If more than one bully add their names here {/* <div style={{ marginBottom: "2%", marginTop: "2%" }}> */}
							...
							<InputField size="small" color="secondary" name="staff_witness" type="text" variant="outlined" />
							<br />
							What actions did the teacher / staff member take?{" "}
							<InputField size="small" color="secondary" name="staff_action" type="text" variant="outlined" />
							<br />
							Where did this incident occur? <InputField size="small" color="secondary" name="incident_place" type="text" variant="outlined" />
							<br />
							...
							In complete detail provide all information you have on this threat.{" "}
							<InputField size="small" color="secondary" name="details" type="text" variant="outlined" />
							<br />
						...
						<Modal open={oepnAddBully} onClose={oepnAddBullyModal} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
							<Box sx={style}>
								<Form initialValues={{}} buttonText="save" buttonSize="medium" submit={submitBully}>
									...
									<div style={{ marginBottom: "2%", marginTop: "2%" }}>
										<Button variant="contained" endIcon={<AddCircleRounded />} onClick={() => handleBullyCount()}>
											Add Bully
										</Button>
									</div>
									{/* <div style={{ marginBottom: "2%", marginTop: "2%" }}>
					...
					<StyledTabPanel value={value} index={4}>
						...
						<Form initialValues={bullyingReportForm} buttonText="submit report" buttonSize="medium" submit={sendBullyingReport}>
							...
							<InputField size="small" color="secondary" name="bully_finitial" type="text" variant="outlined" />
							<br />
							What is the cyberbully’s last name <InputField size="small" color="secondary" name="bully_lname" type="text" variant="outlined" />
							<br />
							Full name of cyberbully <InputField size="small" color="secondary" name="bully_fullname" type="text" variant="outlined" />
							<br />
							Gender of cyberbully: <br />
							<FRadioButton name="gender" options={["Male", "Female"]} /> <br />
							Grade of cyberbully. <InputField size="small" color="secondary" name="bully_grade" type="text" variant="outlined" />
							<br />
							Homeroom Teacher of cyberbully <InputField size="small" color="secondary" name="bully_teacher" type="text" variant="outlined" />
							<br />
							Date of incident <InputField size="small" color="secondary" name="incident_date" type="date" variant="outlined" />
							<br />
							Time of incident <InputField size="small" color="secondary" name="incident_time" type="time" variant="outlined" />
							...
							<InputField size="small" color="secondary" name="details" type="text" variant="outlined" isMultiline={true} />
							<br />
					...
					<StyledTabPanel value={value} index={5}>
						...
						<Form initialValues={bullyingReportForm} buttonText="submit report" buttonSize="medium" submit={sendBullyingReport}>
							...
							/>
							<br />I have uploaded an identification video in the Threat Alert System database. You can view this video at www.threatalert.us under
							my username <InputField size="small" color="secondary" name="usernmae" type="text" variant="outlined" />. <br />
							If you have any further questions or need to immediately verify this information please contact me and I will provide the answers for
							you. <br />
							Your Full Name <InputField size="small" color="secondary" name="full_name" type="text" variant="outlined" />
							<br />
							...
							<InputField size="small" color="secondary" name="admin_email" type="text" variant="outlined" />
							<br />
