...
interface AsianAmericanStudentsProps {
    
}
 
const AsianAmericanStudents: FunctionComponent<AsianAmericanStudentsProps> = () => {
    const [response, setResponse] = React.useState({} as any);
    const [loading, setLoading] = React.useState(false);
    const [selectedPage] = React.useState('Asian American Students');
...
export default AsianAmericanStudents;