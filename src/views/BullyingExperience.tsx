  ...
  return (
    <div style={{ width: "100%" }}>
      <div style={{ width: "60%", marginLeft: "auto", marginRight: "auto" }}>
        If you are the parent/guardian of a student who has been bullied we are interested in your
        story. We are especially interested in situations where the parents/guardians have made
        every effort to work with school administrators to get the abuse stopped but the bullying
        continued. Please use the form below to share your story. _______________ email address Tell
        us about your experience and please include any advice you may have for us to make our
        system work even better for you:
      </div>
