...
const ManageReports: FunctionComponent<ManageReportsProps> = () => {
	...
	return (
        ...
        >
			...
			<FormFieldWrapper>
				<TextField id="outlined-basic" label="Search" variant="outlined" fullWidth={true} onChange={(e) => displayMatches(e.target.value)} />
			</FormFieldWrapper>
			<DataTable defaultSortColumn="expiry" rowId={"report_id"} columns={columns} rows={wordSearched.length > 0 ? wordSearched : rows}></DataTable>
					...
					<Box sx={style}>
						{result.report_type === "bully" && (
							<>
								...
								familiar with The BullyVaxx system please go to www.bullyvaxx.com for details. Once you are on the site if you will click on the
								School Administrator tab at the top of the Home page complete instructions for BullyVaxx will be provided for you. At the bottom of
								this page is a link where you can review my identification video. Thank you
								<br />
								...
								<br />
								Names of any other students that supported the bully’s actions {result.other_incidents}
								<br />
								...
								<br />
								Have you witnessed this bully abusing other students in the past? {result.serial_bully}
								<br />
								...
								<br />
								Please send me a reply email confirming that you have received this information, this will allow me to know that the information that
								I have submitted is being properly addressed. Thank you.
								<br />
							</>
						)}
						...
						{result.report_type === "weapon in school" && (
							<>
								I have information concernating a threat against your school. I am reporting this information through The BullyVaxx system. If you are
								not familiar with The BullyVaxx system please go to www.bullyvaxx.com for details. Once you are on the site if you will click on the
								School Administrator tab at the top of the Home page complete instructions for BullyVaxx will be provided for you. At the bottom of
								this page is a link where you can review my identification video. Thank you
								<br />
								{result.trustee_or_not}
								...
								<br />
								In complete detail provide all information you have on this threat {result.other_incidents}
								<br />
								Dear Principal, please send me a reply email confirming that you have received this information, this will allow me to know that the
								information that I have submitted is being properly addressed. Thank you. <br />
							</>
						)}
